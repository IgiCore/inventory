...
namespace IgiCore.Inventory.Server.Tests
{
	...
	{
		public static Mock<MockableDbSetWithExtensions<TEntity>> SetupData<TEntity>(this Mock<MockableDbSetWithExtensions<TEntity>> mock, ICollection<TEntity> data = null, Func<object[], TEntity> find = null)
	where TEntity : class
		{
